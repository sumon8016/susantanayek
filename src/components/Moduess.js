...
export default function Moduess(props){
    return (
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link" style={{color:props.mode==='dark'?'white':'#042743'}}to="/about">{props.about}</Link>
 ...
 Moduess.propTypes={title:PropTypes.string,
